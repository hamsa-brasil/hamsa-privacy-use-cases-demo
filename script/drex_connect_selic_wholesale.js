...
async function bankBuyTpftFromOtherBank(
  ...
  console.log(
    buyerBankInfo.bankName + "("+ buyerBankInfo.address +")"+ " RD post balance",
    displayBalance(balance)
  );
  balance = await realDigital.safeBalanceOf(
    sellerBankInfo.address,
  ...
  console.log(`
    ${sellerBankInfo.bankName} (${sellerBankInfo.address}) RD post balance`,
    displayBalance(balance)
  );
  balance = await tpft.balanceOf(sellerBankInfo.address, id);
  console.log(
